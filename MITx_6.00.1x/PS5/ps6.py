...
WORDLIST_FILENAME = 'C:/Users/David Jaggi/Documents/GitHub/Miniprojects/MITx_6.00.1x/PS5/words.txt'
...
class PlaintextMessage(Message):
    ...
    def get_encrypting_dict(self):
        ...
        '''
        self.encrtypting_dict = self.build_shift_dict(self.shift)
        return self.encrtypting_dict.copy()
    ...
    def change_shift(self, shift):
        ...
        self.encrtypting_dict = self.build_shift_dict(diff)
