...
WORDLIST_FILENAME = "C:/Users/David Jaggi/Documents/GitHub/Miniprojects/MITx_6.00.1x/PS4/words.txt"
...
def playGame(wordList):
    ...
    preChoice = 'f'
    while True:
        choice = str(input('Enter n to deal a new hand, r to replay the last hand, or e to end the game: '))
        if choice == 'n':
